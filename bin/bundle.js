...
// event handler.
function application(root, model, component) {
  var state$ = stream(model);

  var handleEvent = function rec(action) {
    var currentState = state$();
...
var model = exports.model = hashMap('fetch', true, 'loading', false, 'data', [], 'page', 1, 'pageSize', 20);
...
var init = exports.init = function init() {
  ...
  return model.assoc.apply(model, _toConsumableArray(props || []));
};
...
var update = exports.update = function update(model, action) {
  return Action.case({
    InitGet: function InitGet() {
      return [Action.Get(), model.assoc('fetch', false, 'loading', true)];
    },
    Get: function Get() {
...
},{"./config":46,"./throbber":51,"flyd":3,"mori":14,"snabbdom/h":27,"then-request":37,"union-type":45}],49:[function(require,module,exports){
'use strict';
